<div class="container">
    <div class="page-title">
        <h4 class="mt-5 font-weight-bold text-center">Danh sách các loại màu</h4>
    </div>
    <div class="box box-primary">
        <div class="box-body">
        
        <!-- <a href="index.php?act=addms"><input type="submit" class="btn btn-success mb-1" value="Nhập thêm"></a>   -->
        <a href="index.php?act=addms" class="btn btn-success text-white">Thêm mới<i class="fas fa-plus-circle"></i></a>
        <?php
				if(isset($thongbao)) { ?>
